...
finetuning('ver', batch_size=BATCH_SIZE[1], epochs=EPOCH, acc_grad=ACCUMULATE_GRAD[0], gpus=N_GPUS)
finetuning('score', batch_size=BATCH_SIZE[0], epochs=EPOCH, acc_grad=ACCUMULATE_GRAD[0], gpus=N_GPUS)
